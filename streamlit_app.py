...
""", unsafe_allow_html=True)
            ...
            with st.container():
                st.markdown("<div class='result-card'>", unsafe_allow_html=True)
                st.markdown("Extracted keywords") # Bolding for better structure
                ...
                st.markdown("Suggested business model(s)") # Bolding for better structure
            ...
            with st.container():
                st.markdown("<div classs='result-card'>", unsafe_allow_html=True)
                st.markdown("Key risks") # Bolding for better structure
                for r in risks:
                    st.markdown(f"- {r}")
                st.markdown("<hr style='margin-top:12px;margin-bottom:12px'/>", unsafe_allow_html=True)
                st.markdown("Recommended next steps") # Bolding for better structure
